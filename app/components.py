...
def BottomPanel(sorted_hours: pd.DataFrame):
    ...
    display_time = sorted_hours[time_index.value].strftime('%b %d, %H:00 - %H:59') if sorted_hours else 'Loading...' # Display on top of slider
